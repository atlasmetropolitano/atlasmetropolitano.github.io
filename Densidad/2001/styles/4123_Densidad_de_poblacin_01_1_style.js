...
var style_4123_Densidad_de_poblacin_01_1 = function(feature, resolution){
    ...
    if (value >= 0.000000 && value <= 97.370340) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 97.370340 && value <= 629.424877) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 629.424877 && value <= 3003.992059) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3003.992059 && value <= 5376.630952) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5376.630952 && value <= 13675.605911) {
            style = [ new ol.style.Style({
