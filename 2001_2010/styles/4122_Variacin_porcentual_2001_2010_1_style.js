...
var style_4122_Variacin_porcentual_2001_2010_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("vp0110");
    var labelText = "";
    size = 0;
    ...
    if (value >= -78.371747 && value <= 4.118209) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.118209 && value <= 10.343028) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.343028 && value <= 13.578698) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.578698 && value <= 23.351464) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.351464 && value <= 3136.159075) {
            style = [ new ol.style.Style({
