...
var style_4122_Variacin_porcentual_1991_2001_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Variación");
    var labelText = "";
    size = 0;
    ...
    if (value >= -2.495294 && value <= 10.847804) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.847804 && value <= 36.062205) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 36.062205 && value <= 60.304395) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 60.304395 && value <= 100.244826) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 100.244826 && value <= 194.956906) {
            style = [ new ol.style.Style({
