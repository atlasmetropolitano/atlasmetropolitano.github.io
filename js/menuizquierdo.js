document.addEventListener("DOMContentLoaded", () => {
    ...
    options.forEach(option => {
        option.addEventListener("click", function(event) {
            ...
            const selectedTopic = this.innerText.trim(); // Obtener el nombre del tema seleccionado
            ...
            // 🔹 Enviar el tema seleccionado al menú derecho
            document.dispatchEvent(new CustomEvent("syncMenuRight", { detail: { topic: selectedTopic } }));
        });
    });
