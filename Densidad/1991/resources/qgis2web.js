...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_4123_Densidad_de_poblacin_91_EX_1,
      colName: 'NAM',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-59.930554, -35.462306, -57.156187, -33.766008], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://github.com/tomchadwin/qgis2web">CIM -</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://openlayers.org/">FADU -</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="https://qgis.org/">UBA</a>';
